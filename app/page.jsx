  ...
  return (
    <div className="dark:bg-[#111a31] bg-gray-50">
      ...
      <div className="flex max-w-5xl mx-auto flex-col items-center justify-center min-h-screen flex max-w-5xl mx-auto flex-col items-center justify-center py-2">
        ...
        <main className="flex z-10 flex-1 w-full flex-col items-center justify-center text-center px-4 ">
          <h1 className="mx-auto z-2  max-w-4xl font-bold text-3xl tracking-tight text-slate-900 sm:text-6xl dark:text-white">
            高等院校三千所 助力考生选大学{' '}
